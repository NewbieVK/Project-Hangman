...
Create a web based game of Hangman using JavaScript, HTML and SASS.
...
Disable or remove the buttons if a letter has been guessed
...
Could keep track of win vs loss here or have the words be different color?
Should remove words that have already been used so they are not selected again?
